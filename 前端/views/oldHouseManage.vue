    ...
    <el-card>
      <el-row :gutter="20">
      	<!-- <el-checkbox-group v-model="queryInfo.querytype"> -->
      		<el-col :span="7">
      			<el-input placeholder="请输入内容" v-model="queryInfo.query.h_uid[0]" clearable @clear="getOldhouseList">
      		...
      		<el-col :span="7">
      			...
      			<el-input placeholder="请输入内容" v-model="queryInfo.query.hid[0]" clearable @clear="getOldhouseList">
      				<template slot="prepend">按房源编号查询</template>
      				<!-- <el-button slot="append" icon="el-icon-search" @click="getOldhouseList"></el-button> -->
      			</el-input>
      		</el-col>
      		<el-col :span="2">
      			<!-- <el-link icon="el-icon-edit" @click="deleteMany">编辑</el-link> -->
      			<el-button type="primary" @click="getOldhouseList" icon="el-icon-search" >查询</el-button>
      		</el-col>
      		<el-col :span="4">
      			<!-- <el-link icon="el-icon-edit" @click="deleteMany">编辑</el-link> -->
      ...
      <!-- 表格数据 -->
      <el-table :data="oldhouseList" border stripe ref="multipleTable" @selection-change="handleSelectionChange" height="480">
...
export default {
  ...
  methods: {
	  ...
	  async getAllhouseList() {
	  	...
	  	console.log('resold : '+res.data.length);

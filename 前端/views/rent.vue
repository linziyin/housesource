<template>
  <div>
    ...
    <div class="querys">
      ...
      <el-row><label>租金</label>
        <el-radio-group v-model="radio3" @change="rad">
          <el-radio-button label="0">1500/月以下</el-radio-button>
          <el-radio-button label="1">1500/月-2000/月</el-radio-button>
          <el-radio-button label="2">2000/月-4000/月</el-radio-button>
          <el-radio-button label="3">4000/月-6000/月</el-radio-button>
          <el-radio-button label="4">6000/月-8000/月</el-radio-button>
          <el-radio-button label="5">8000/月以上</el-radio-button>
        </el-radio-group>
      </el-row>
...
export default {
  data() {
    return {
      ...
      price:[[0,1500],[1500,2000],[2000,4000],[4000,6000],[6000,8000],[1,8000]]
    };
  },
